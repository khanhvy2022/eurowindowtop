...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    href: "/san-pham",
    children: [
      { label: "CỬA NHÔM", href: "/san-pham/cua-nhom" },
      { label: "CỬA uPVC", href: "/san-pham/cua-nhua-upvc" },
      { label: "CỬA GỖ", href: "/san-pham/cua-go" },
      { label: "CỬA CUỐN", href: "/san-pham/cua-cuon" },
      { label: "CỬA TỰ ĐỘNG", href: "/san-pham/cua-tu-dong" },
      { label: "SẢN PHẨM KÍNH", href: "/san-pham/san-pham-kinh" },
      { label: "CỬA THÔNG MINH THẾ HỆ MỚI", href: "/san-pham/cua-thong-minh" },
    ],
  },
  {
    id: "showroom",
